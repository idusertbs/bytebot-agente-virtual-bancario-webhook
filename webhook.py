                            ...
                            for k in range(0,indice_final_pagina):
                                if float(cuentas_tipo_movimiento_monto[k]) > 0:
                                    if solo_carrusel:
                                        ...
                                        json_string = u'{"title": "' + cuentas_tipo_movimiento_monedas + " " + format(float(cuentas_tipo_movimiento_monto[k]),',') + '", "subtitle": "' + cuentas_tipo_movimiento_descripcion[k] + cuentas_tipo_movimiento_dias[k] +'","image_url": "https://raw.githubusercontent.com/idusertbs/bytebot-agente-virtual-bancario-webhook/master/bytebot_agente_bancario_assets/plus_2.png"}'
                                else:
                                    if solo_carrusel:
